...
resource "azurestack_image" "import" {
  name                = azurestack_image.test.name
  location            = azurestack_image.test.location
  resource_group_name = azurestack_image.test.resource_group_name
...
resource "azurestack_network_interface" "testdestination" {
...
resource "azurestack_virtual_machine" "testdestination" {
  name                  = "acctvm"
  location              = azurestack_resource_group.test.location
  resource_group_name   = azurestack_resource_group.test.name
...
resource "azurestack_image" "testdestination" {
  ...
  location                  = azurestack_resource_group.test.location
  resource_group_name       = azurestack_resource_group.test.name
  source_virtual_machine_id = azurestack_virtual_machine.testsource.id
...
resource "azurestack_virtual_machine_scale_set" "testdestination" {
  name                = "testdestination"
  location            = azurestack_resource_group.test.location
  resource_group_name = azurestack_resource_group.test.name
