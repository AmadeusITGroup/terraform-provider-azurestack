...
fun ParametrizedWithType.ConfigureAzureSpecificTestParameters(endpoint: String, config: ClientConfiguration, locationsForEnv: LocationConfiguration) {
    ...
    hiddenVariable("env.ARM_ENDPOINT", endpoint, "The Azure Stack Endpoint to use")
