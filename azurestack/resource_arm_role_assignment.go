		...
		Schema: map[string]*schema.Schema{
			...
			"scope": {
				...
				ValidateFunc: validation.Any(
					azureValidate.ManagementGroupID,
					azureValidate.SubscriptionID,
					azureValidate.ValidateResourceID,
				),
			},
...
func resourceArmRoleAssignmentCreate(d *schema.ResourceData, meta interface{}) error {
	roleAssignmentsClient := meta.(*ArmClient).authorizationClient.RoleAssignmentsClient
	roleDefinitionsClient := meta.(*ArmClient).authorizationClient.RoleDefinitionsClient
...
func resourceArmRoleAssignmentRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ArmClient).authorizationClient.RoleAssignmentsClient
	roleDefinitionsClient := meta.(*ArmClient).authorizationClient.RoleDefinitionsClient
